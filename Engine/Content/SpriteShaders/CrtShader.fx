...
// Replicates the color sampling with gamma correction
...
// --- NEW FUNCTION: rand ---
// Random noise generator for effects
...
float4 MainPS(VertexShaderOutput input) : COLOR
{
    ...
    // Calculate wiggle effect (scanline interference)
    ...
    // Time loop? Mattias "make time do something again"
    time = float(mod(FrameCount, 640.0) * 1);
    ...
    /* Ghosting */ // Change it to use blurbuffer
