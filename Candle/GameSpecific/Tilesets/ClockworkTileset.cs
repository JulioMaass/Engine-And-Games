...
namespace Candle.GameSpecific.Tilesets;

public class ClockworkTileset : Tileset
{
    public ClockworkTileset()
    {
        Texture = Drawer.TextureDictionary.GetValueOrDefault("ClockworkTileset");
