...
namespace MMDB.GameSpecific.Entities.Enemies.PoliceEnemies;

public class PoliceJoe : Entity
{
    public PoliceJoe()
    {
        ...
        Shooter.AngleRounding = 45000 / 4;
        Shooter.RoundSpeed = true;
        ...
        var stateShoot = NewStateWithTimedPattern(new StateDefault("Shoot"), (8, 8), (9, 104), (8, 8))
            ...
            .AddPostProcessingBehaviorWithConditions(new BehaviorShoot(), new ConditionFrameEqual(50))
            .AddPostProcessingBehaviorWithConditions(new BehaviorShoot(), new ConditionFrameEqual(55))
            .AddPostProcessingBehaviorWithConditions(new BehaviorShoot(), new ConditionFrameEqual(60))
            .AddPostProcessingBehaviorWithConditions(new BehaviorShoot(), new ConditionFrameEqual(65))
            .AddPostProcessingBehaviorWithConditions(new BehaviorShoot(), new ConditionFrameEqual(70));
